...
- **Mettre en maintenance un véhicule déjà parti en mission est enfin possible** — le bouton « 🔧 Maintenance » était masqué dès que le véhicule était emprunté, alors que c'est le cas le plus courant : quelqu'un prend le véhicule justement pour l'amener à l'atelier. La maintenance peut désormais être déclarée sans attendre le retour. Le bouton s'efface une fois la maintenance en cours, le bandeau prenant le relais.
